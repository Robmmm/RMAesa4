...
jQuery(document).ready(function ($) {
    ...
    /*create Item Funktion*/
    $('ul.todo-list li .create-btn').on('click', function () {
        var $newItem = createNewItem($(this).closest('ul.todo-list > li'));
        /*Item Editier Modus on*/
        // if (editItem) {
        //     setEditModeItem();
        // }
    ...
    function unEditModeItem() {
        ...
        editItem = null;
                    ...
                    function createNewItem(event) {
                        ...
                        $newItem = $("content ul").append(newListItem); //Clone erstellen, data und events einbeziehen
                        setCheckboxAttributes($newItem.find('input[type="checkbox"]'), uniqueItemID++); //checkbox attribute neu setzen
                                                                                                      //für korrekte checkbox-label Zugehörigkeit
                        $newItem.insertAfter($item); //neues Element nach Original einfügen
                        // toggleMenuItemBarOpen($item); //Menü des original Elements schließen
                    ...
                    function onNewListClick() {
                        ...
                        $('ul.todo-list li input').each(function () {
